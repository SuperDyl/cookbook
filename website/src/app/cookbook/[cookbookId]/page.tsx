...
import { Cookbook } from "server-api/build/shared-types";
...
export default function EditCookbookPage({params}: EditRecipesPageProps) {
  ...
  //   },
  //   [api, author, ingredients, instructions, cookbookId, title, url]);
    ...
    () => {
      async function getCookbook() {
        ...
        if (cookbook !== null) {
          ...
          // setUrl(cookbook.url ?? '');
          // setIngredients(cookbook.ingredients);
          // setInstructions(cookbook.instructions);
        }
