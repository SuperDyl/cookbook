...
export const DarkTheme: DefaultTheme = {
	...
	text: nearWhite,
	textCompliment: nearWhiteCompliment,
...
export const LightTheme: DefaultTheme = {
	...
	backgroundCompliment: nearWhiteCompliment,
	text: nearBlack,
	textCompliment: nearBlackCompliment,
